...
export default function RiskComplianceDomainPage() {
    ...
    <div className="container mx-auto py-6 max-w-5xl">
      ...
      <Card className="mb-8">
        <CardHeader>
          ...
          <CardDescription>
            Risk & Compliance encompasses the processes, policies, and controls that ensure your firm meets legal,
            regulatory, and contractual obligations while managing operational risks effectively.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <p>
            For legal institutions, effective risk and compliance management is essential for maintaining client trust,
            protecting sensitive information, and ensuring business continuity. This domain covers risk assessment,
            policy management, regulatory compliance, and governance structures.
          </p>
        </CardContent>
      </Card>
