...
export default function IncidentProblemInitialPage() {
  ...
  return (
    <div className="container max-w-5xl py-6 md:py-10">
      ...
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-2">Incident & Problem Management — Initial (1.0–1.9)</h1>
      ...
      <Card className="mb-8">
        ...
        <CardContent className="prose max-w-none">
          <DynamicContent
            ...
            fallbackContent={
              <p>SAMPLE TEXT - What This Score Means for Incident & Problem Management at Initial level</p>
            }
          />
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>{/* Placeholder for Related Playbook Links content */}</CardContent>
      </Card>
    </div>
  )
}
